  ...
  class RainDrop{
      ...
      update() {
        ...
        if(this.y < this.end){
          ...
          this.x += this.s.map(this.s.noise(this.s.millis()/1000), 0, 1, -1, 1)*2; 
          this.y += this.speed;
        } 
        else {
          rainSplash = new RainSplash(this.s, this.x, this.y, this.z, (this.y / this.s.height) * 1, this.colorBackground, this.colorForeground)
          this.reset(0);
        }
      ...
      draw(){
        ...
        this.s.stroke(this.s.lerpColor(this.colorBackground, this.colorForeground, this.z));
